...
from utils import INDICATOR_PAIR_MAP, HB_PROVINCES, concordance_value, concordance_overall, shade_cell, color_for_conc
...
def build_table2(df_raw):
    ...
    for ind, (mrf_col, ehr_col) in INDICATOR_PAIR_MAP.items():
        ...
        tmp["Concordance_%"] = tmp.apply(lambda r: concordance_value(r["MRF"], r["E_HR"]), axis=1)
